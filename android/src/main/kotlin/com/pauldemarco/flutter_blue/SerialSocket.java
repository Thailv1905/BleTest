...
//import vn.selex.selexbase.database.DeviceConnected;
//import vn.selex.selexbase.utils.DisconnectEvent;
//import vn.selex.selexbase.utils.RxBus;
    ...
    public SerialSocket(Context context, BluetoothDevice device) {
        ...
        disconnectBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                try {
                    write(new BleData("W", "N", new SendData(Const.DISCONNECT, "0")).toByte());
...
//    }
//
//    public DeviceConnected getDBDeviceConnected(){
...
//    }
    ...
    void connect(SerialListener listener) throws IOException {
        ...
        context.registerReceiver(disconnectBroadcastReceiver, new IntentFilter(Const.INTENT_ACTION_DISCONNECT));
    ...
    private void onPairingBroadcastReceive(Context context, Intent intent) {
        ...
        switch (intent.getAction()) {
            case BluetoothDevice.ACTION_PAIRING_REQUEST:
                ...
                onSerialConnectError(new IOException("Base error"));
...
//            RxBus.INSTANCE.publish(new Reconnect(true));
            isDisConnect = false;
        }
    }
...
//        try{
//            //checkId
//            BleData data = new BleData("W", "E", new SendData(BleConstants.CHECK_ID, BleConstants.INSTANCE.getDeviceId()));
//            write(data.toByte());
//            new Handler(Looper.getMainLooper()).postDelayed(() -> {
//                BleData checkOTP = new BleData("W", "E", new SendData(BleConstants.CHECK_OTP, BleConstants.INSTANCE.getOTP()));
//                try {
//                    write(checkOTP.toByte());
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
//            },1000);
...
//    }
    ...
    void write(byte[] data) throws IOException {
        Log.d(TAG,"cancel: "+canceled+ " connected: "+connected+ " write: "+(writeCharacteristic==null));
...
//            throw new IOException("not connected");
    ...
    private void onSerialRead(byte[] data) {
        if (data != null) {
            ...
            try {
                BleResponseSate state = new Gson().fromJson(response, BleResponseSate.class);
                if (state.getData().getObjectSend().equals(Const.DISCONNECT)) {
                    disconnect();
//                    RxBus.INSTANCE.publish(new DisconnectEvent(true));
                }
            } catch (Exception e) {
